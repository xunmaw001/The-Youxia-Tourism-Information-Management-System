                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../lvxingtuan/detail.jsp?id='+item.id)">
                                    <a href="#" class="ng-prsliik">
                                        <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                            <img class="swiper-item" :src="item.lvxingtuanPhoto?item.lvxingtuanPhoto.split(',')[0]:''" />
                                        </span>
                                ...
                                <div class="ng-prslist-tit" @click="jump('../lvxingtuan/detail.jsp?id='+item.id)"><span>{{item.lvxingtuanName}}</span></div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 lvxingtuanContent 字段去除无用字符 如果字段长度大于60  就截取到60
            lvxingtuanContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            // 当前表
                                            // 获取列表数据
            http.request('lvxingtuan/list', 'get', param, function(res) {
