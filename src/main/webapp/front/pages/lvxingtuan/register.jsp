              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">旅行地点:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="lvxingtuanName" id="lvxingtuanName"  lay-verify="integer|required"   placeholder="旅行地点" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">旅行时间(天):</span>
                        <div class="layui-input-inline">
                            <input type="text" name="jiudianShijian" id="jiudianShijian"  lay-verify="integer|required"   placeholder="旅行时间(天)" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="lvxingtuanMoney" id="lvxingtuanMoney"  lay-verify="double|required"   placeholder="价格" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
