					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="jiudianOrderStartTime" id="jiudianOrderStartTime"  lay-verify="required|date"   placeholder="预定开始时间" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="jiudianOrderEndTime" id="jiudianOrderEndTime"  lay-verify="required|date"   placeholder="预定结束时间" autocomplete="off" class="layui-input">
							</div>
						</div>
