              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">商品名称:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="shangpinName" id="shangpinName"  lay-verify="integer|required"   placeholder="商品名称" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">商品类型:</span>
                        <div class="layui-input-inline">
                            <select name="shangpinTypes" id="shangpinTypes" lay-filter="shangpinTypes" style="width: 600px;">
                ...
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">商品价格:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="shangpinMoney" id="shangpinMoney"  placeholder="商品价格"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
