        ...
        <form class="layui-form layui-form-pane" lay-filter="myForm">
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-inline">
                    <input v-model="detail.shangpinName" type="text" name="shangpinName" id="shangpinName" lay-verify="integer|required"   placeholder="商品名称" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input v-model="detail.shangpinMoney" type="text" name="shangpinMoney" id="shangpinMoney" placeholder="商品价格" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
