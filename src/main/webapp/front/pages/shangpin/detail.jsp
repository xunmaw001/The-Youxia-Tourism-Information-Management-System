    ...
    <div class="data-detail">
        ...
        <div class="layui-row">
            ...
            <div class="layui-col-md7" style="padding-left: 20px;">
                <div v-if="detail.shangpinName" class="detail-item">
                    <span>商品名称：</span>
                    <span class="desc">
                        {{detail.shangpinName}}
                    </span>
                ...
                <div v-if="detail.shangpinMoney" class="detail-item">
                    <span>商品价格：</span>
                    <span class="desc">
                                {{detail.shangpinMoney}}
                            </span>
                </div>
            ...
            <div class="layui-tab layui-tab-card">
                ...
                <div class="layui-tab-content">
                    ...
                    <div class="layui-tab-item layui-show">
                        <div v-html="detail.shangpinContent"></div>
                    </div>
