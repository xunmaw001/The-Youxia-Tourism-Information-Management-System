                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="shangpinNameStart" id="shangpinNameStart"  lay-skin="integer"   placeholder="商品名称开始" autocomplete="off" class="layui-input">
                              -
                              <input type="text" name="shangpinNameend"   id="shangpinNameend"    lay-skin="integer|shangpinNameend"   placeholder="商品名称结束" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 shangpinContent 字段去除无用字符 如果字段长度大于60  就截取到60
            shangpinContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        form.verify({
            ...
            ,shangpinNameend: function(value, item){ //value：表单的值、item：表单的DOM对象
                    var shangpinNameStart = $("#shangpinNameStart").val();
                 if(shangpinNameStart != null && shangpinNameStart != "" && shangpinNameStart != "null"){
                    var number = parseInt(value)- parseInt(shangpinNameStart);
                    if(number<0){
                        return '商品名称的结束值不能小于开始值';
                    }
                 }
            }
        ...
        function pageList() {
            ...
            if (jquery('#shangpinNameStart').val() != null && jquery('#shangpinNameStart').val() != "" && jquery('#shangpinNameStart').val() != "null" ) {
                param['shangpinNameStart'] = jquery('#shangpinNameStart').val();
            }
            if (jquery('#shangpinNameEnd').val() != null && jquery('#shangpinNameEnd').val() != "" && jquery('#shangpinNameEnd').val() != "null" ) {
                param['shangpinNameEnd'] = jquery('#shangpinNameEnd').val();
            }
