	...
	<body style="background: #EEEEEE;">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="chepiaoOrderStartTime" id="chepiaoOrderStartTime"  lay-verify="required|date"   placeholder="预定时间" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload'], function () {
                ...
                http.request(`chepiaoOrder/session`, 'get', {}, function (data) {
                    // 表单赋值
