...
<div id="app">
    ...
    <div class="line-container">
        <p class="line" style="background: #EEEEEE;"> 我的旅行团订单 </p>
    </div>
    <!-- 标题 -->
            ...
            <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                ...
                <div class="layui-tab-content">
                    <table class="layui-table" lay-skin="nob">
                        ...
                        <td style="width: 50px;">{{item.lvxingtuanId}}</td>
                        <td style="width: 60px;">{{item.lvxingtuanName}}</td>
                        <td style="width: 60px;">{{item.jiudianShijian}}</td>
                        <td style="width: 250px;">
                            <img :src="item.lvxingtuanPhoto" style="width: 100px;height: 100px;object-fit: cover;">
                        </td>
                        <td style="width: 100px;color: red">{{item.lvxingtuanMoney}}</td>
                        <td style="width: 150px;">{{item.lvxingtuanOrderStartTime}}</td>
                        <td style="width: 150px;">{{item.lvxingtuanOrderEndTime}}</td>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 lvxingtuanOrderContent 字段去除无用字符 如果字段长度大于60  就截取到60
            lvxingtuanOrderContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            // 当前表
                                        // 获取列表数据
            http.request('lvxingtuanOrder/list', 'get', param, function(res) {
