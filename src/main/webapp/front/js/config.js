...
var indexNav = [
    {
        name: '旅行团信息',
        url: './pages/lvxingtuan/list.jsp'
    },
    {
        name: '车票',
        url: './pages/chepiao/list.jsp'
    },
    {
        name: '酒店',
...
var adminurl =  "http://localhost:8080/youxialvxing/index.jsp";
