            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">旅行团订单登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="lvxingsheId" name="lvxingsheId" class="form-control"
                                                   v-model="ruleForm.lvxingsheId" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="lvxingtuanName" name="lvxingtuanName" class="form-control"
                                                   v-model="ruleForm.lvxingtuanName" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="jiudianShijian" name="jiudianShijian" class="form-control"
                                                   v-model="ruleForm.jiudianShijian" readonly>
                                        </div>


                                    <div class="form-group col-md-6">
                                        <label>预览图</label>
                                        <img id="lvxingtuanPhotoImg" width="100" height="100">
                                    </div>

                                        <div class="form-group col-md-6">
                                            <label>价格</label>
                                            <input id="lvxingtuanMoney" name="lvxingtuanMoney" class="form-control"
                                                   v-model="ruleForm.lvxingtuanMoney" readonly>
                                        </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="lvxingtuanId" name="lvxingtuanId" v-model="ruleForm.lvxingtuanId" readonly type="hidden">
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">

                                    <div class="form-group col-md-6">
                                        <label>开始时间</label>
                                        <input id="lvxingtuanOrderStartTime" name="lvxingtuanOrderStartTime" class="form-control"
                                               v-model="ruleForm.lvxingtuanOrderStartTime" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>结束时间</label>
                                        <input id="lvxingtuanOrderEndTime" name="lvxingtuanOrderEndTime" class="form-control"
                                               v-model="ruleForm.lvxingtuanOrderEndTime" readonly>
                                    </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "lvxingtuanOrder/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.lvxingtuanContent != null && ruleForm.lvxingtuanContent != 'null' && ruleForm.lvxingtuanContent != '') {
            var lvxingtuanContentUeditor = UE.getEditor('lvxingtuanContentEditor');
                lvxingtuanContentUeditor.ready(function () {
                    ...
                    lvxingtuanContentUeditor.setDisabled('fullscreen');
            });
        }
    }
