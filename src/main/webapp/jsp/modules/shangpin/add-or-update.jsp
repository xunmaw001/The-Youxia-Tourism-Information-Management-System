                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>商品价格</label>
                                        <input id="shangpinMoney" name="shangpinMoney" class="form-control"
                                               placeholder="商品价格">
                                    </div>
                                    <div class="form-group  col-md-6">
                                        <label>商品详情</label>
...
<script>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                ...
                shangpinMoney: "required",
                shangpinContent: "required",
            },
            messages: {
                shangpinName: "商品名称不能为空",
                shangpinPhoto: "商品图片不能为空",
                shangpinTypes: "商品类型不能为空",
                shangpinMoney: "商品价格不能为空",
                shangpinContent: "商品详情不能为空",
            }
        }).form();
    }
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#shangpinMoney").val(ruleForm.shangpinMoney);
